...
class AddCountdown extends Command {
    ...
    protected function configure(): void {
        $this->setName(self::$defaultName)
             ...
             ->addArgument('starting_year', InputArgument::OPTIONAL, 'Starting/Birth year for yearly recurrence (e.g., 1995)');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int {
        ...
        $startingYearArg = $input->getArgument('starting_year');
        $startingYear = $startingYearArg !== null ? (int)$startingYearArg : null;
        ...
        $newCd = $this->notificationService->addCountdown($userId, $name, $targetDateMs, $repeat, 1.0, $startingYear);
