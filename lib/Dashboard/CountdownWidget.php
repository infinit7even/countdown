...
class CountdownWidget implements IWidget, IButtonWidget, IIconWidget {
    ...
    public function getIconUrl(): string {
        return $this->urlGenerator->getAbsoluteURL(
            $this->urlGenerator->imagePath('countdown', 'countdown-white.svg')
        );
    }
